package cn.lunadeer.dominion.v1_20_1_spigot.events;
...
public class EnvironmentEvents implements Listener {
    ...
    public static CancellableTask entityMoveTask = Scheduler.runTaskRepeat(() -> {
    ...
    public static CancellableTask entityMoveCleanTask = Scheduler.runTaskRepeat(() -> {
